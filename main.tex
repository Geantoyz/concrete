...
\begin{enumerate}
    ...
    \item Обчислюємо $\alpha_m$:
        ...
        $$\alpha_m = \dfrac{M_{max}}{b_{eff} \cdot d^2f_{cd}} = \dfrac{44,58 \cdot 10^3}{1,31 \cdot 0,26^2 \cdot 17 \cdot 10^6} = 0,029 \Rightarrow 0,031$$
        $\xi = \dfrac{x}{d} \Rightarrow x = \xi \cdot d = 0,04 \cdot 260 = 10,4\;\textit{мм}$
