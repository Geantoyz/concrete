...
\begin{table}[h]
    ...
    \hline
      & Вид конструкції                                                   & \begin{tabular}[c]{@{}l@{}}Нормативне \\ значення \\ $g_n$, $\textit{кН/м}^2$\end{tabular} & $\gamma_f$ & \begin{tabular}[c]{@{}l@{}}Розрахункове\\ навантаження \\ $g_p$\end{tabular} \\ \hline
