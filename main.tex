...
\end{figure}
   \begin{table}[h]
    \begin{center}
    \caption{Навантаження від покрівлі}
    \begin{tabular}{|c|l|c|c|c|}
    \hline
      & Вид конструкції                                                   & \begin{tabular}[c]{@{}l@{}}Нормативне \\ значення \\ $g_n$, $\textit{кН/м}^2$\end{tabular} & $\gamma_f$ & \begin{tabular}[c]{@{}l@{}}Розрахункове\\ навантаження \\ $g_p\;\textit{кН/м}^2$\end{tabular} \\ \hline
    1 & \begin{tabular}[c]{@{}l@{}}3 шари \\ руберойду\end{tabular}       & 0,15                                                                        & 1,2      & 0,18                                                                      \\ \hline
    2 & \begin{tabular}[c]{@{}l@{}}Цементно піщана \\ стяжка\end{tabular} & 0,5                                                                         & 1,3      & 0,65                                                                      \\ \hline
    3 & Пенобетон                                                         & 0,4                                                                         & 1,2      & 0,48                                                                      \\ \hline
    4 & Пароізоляція                                                      & 0,1                                                                         & 1,2      & 0,12                                                                      \\ \hline
    5 & \begin{tabular}[c]{@{}l@{}}Ребриста плита\\ 3х6\end{tabular}      & 1,333                                                                       & 1,1      & 1,4663                                                                    \\ \hline
      & Всього:                                                            &                                                                             &          & $g_p=3,52$                                                                   \\ \hline
    \end{tabular}
    \end{center}
    \end{table}
 %Сделать таблицу
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[scale=0.5]{2_4.png}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[scale=0.6]{2_5.png}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[scale=0.8 ]{3_0.png}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[scale=0.8]{3_4.png}
...
\end{enumerate}
    ...
    \begin{figure}[h!]
        \begin{center}
            \includegraphics[scale=0.8]{4_0.png}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[scale=0.7]{6_1.png}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[scale=0.8]{6_2.png}
...
\begin{enumerate}
 ...
 \begin{figure}[h!]
     \begin{center}
            \includegraphics[scale=0.8]{6_3.png}
...
\newpage
        ...
        \begin{figure}[h!]
            \begin{center}
                   \includegraphics[scale=0.8]{6_4.png}
...
\begin{enumerate}
    ...
    \item Перевіряємо відсоток армування:
        ...
        \begin{figure}[h!]
            \begin{center}
                   \includegraphics[scale=0.8]{6_5.png}
                   \caption{Армування перерізу верхнього поясу ферми.}\label{ris6_5} 
           \end{center}
        \end{figure}
\end{enumerate}
\newpage
\section*{СПИСОК ВИКОРИСТАНОЇ ЛІТЕРАТУРИ}\addcontentsline{toc}{section}{СПИСОК ВИКОРИСТАНОЇ ЛІТЕРАТУРИ}
\begin{enumerate}
...
\begin{center}
    ...
    \noalign{\phantomsection}\caption{Розрахункові поєднання зусиль ферми прольотом 18 метрів} \\       
